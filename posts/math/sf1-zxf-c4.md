...
1. 确定函数定义域，奇偶性，周期性
2. 确定函数的连续性（需要分析），间断点和类型
3. 如果函数可导，利用导数判断单调性，极值，最值。
4. 如果函数二阶可导，利用二阶导判断函数的凸性，拐点
5. 利用 Taylor 定理 / L'Hospital 法则确定渐近线。
6. 取特殊点，描绘出大致图象
